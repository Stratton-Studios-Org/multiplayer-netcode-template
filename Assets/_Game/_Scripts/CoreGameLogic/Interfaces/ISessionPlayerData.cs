...
using Unity.Collections;
    ...
    [Serializable]
    public struct ISessionPlayerData : INetworkSerializable, System.IEquatable<ISessionPlayerData>
    {
        ...
        public ISessionPlayerData(int score, FixedString128Bytes systemIDd, bool connected, ulong clientID, NetworkObjectReference playerObject)
        {
            playerScore = score;
            systemID = systemIDd;
        ...
        public bool Equals(ISessionPlayerData other)
        {
